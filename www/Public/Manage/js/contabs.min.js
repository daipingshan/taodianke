$(function() {
	//子页面点击切换父页面选项卡
			$(".J_menuItems").on("click",function(){
				event.preventDefault();
				var $url = $(this).attr("href");
				var $title = $(this).text();
				$(".page-tabs-content",parent.document).find(".J_menuTab").removeClass("active");
				$(".page-tabs-content",parent.document).append('<a href="javascript:;" class="J_menuTab active" data-id="'+$url+'">'+$title+'<i class="fa fa-times-circle"></i></a>');
				$("#content-main",parent.document).find(".J_iframe").hide();
				$("#content-main",parent.document).append('<iframe class="J_iframe" name="iframe'+$url+'" width="100%" height="100%" src="'+$url+'" frameborder="0" data-id="'+$url+'" seamless="" style="display: inline;"></iframe>')
			})
