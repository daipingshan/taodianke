/*
  ...
  Last Updated:: 2017/07/12 10:52:49.
  Files include::  /public/jquery/jquery.min.js
*/
(function(e, t) {
	var n, r, i = typeof t,
		o = e.document,
...
0") ?
	...
	b.fn.load = function(e, n, r) {
		...
		ajaxSettings: {
			...
			processData: !0,
			async: !0,
			contentType: "module/x-www-form-urlencoded; charset=UTF-8",
			accepts: {
				"*": Dn,
				text: "text/plain",
				html: "text/html",
				xml: "module/xml, text/xml",
				json: "module/json, text/javascript"
			},
			contents: {
				xml: /xml/,
				html: /html/,
	...
	b.ajaxSetup({
		...
		var o, a, s, u = n.jsonp !== !1 && (Bn.test(n.url) ? "url" : "string" == typeof n.data && !(n.contentType || "").indexOf("module/x-www-form-urlencoded") && Bn.test(n.data) && "data");
