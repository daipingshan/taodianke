...
class NewsController extends CommonController {
    ...
    public function add() {
        ...
        if (IS_POST) {
            ...
            $article_data['user_id']=$uid;
            $res = M('tmnews')->add($article_data);
            if (!$res) {
    ...
    public function edit() {
        if (IS_POST) {
            ...
            $res = M('tmnews')->where(array('id' => $article_id))->save($article_data);
            if ($res === false) {
        ...
        $article_data = M('tmnews')->where(array('id' => $article_id))->find();
