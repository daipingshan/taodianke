...
<div class="page-container">
	...
	<ul class="user-info-menu right-links list-inline list-unstyled">
        ...
        <div class="page-title">
            <div class="title-env">
                <h1 class="title">栏目编辑</h1>
                <p class="description">后台栏目修改</p>
            </div>
            <div class="breadcrumb-env">
                <ol class="breadcrumb bc-1">
                    <li><a href="/AppAdmin/"><i class="fa-home"></i>主页</a></li>
                    <li> 站点设置</li>
                    <li class="active"><strong>栏目编辑</strong></li>
                </ol>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="panel-body">
                        <form role="form" method="post" class="form-horizontal" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="name" value="<?php echo ($menu["name"]); ?>" name="name" placeholder="文章标题内容">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select id="pid" name="pid" class="form-control">
                                        ...
                                        <?php if(is_array($class_list)): foreach($class_list as $key=>$vo): ?><option
                                            <?php if($vo['id'] == $menu['pid']): ?>selected<?php endif; ?>
                                            value="<?php echo ($vo['id']); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group-separator"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="module_name" value="<?php echo ($menu["module_name"]); ?>" name="module_name" placeholder="模块名称">
                                </div>
                            </div>
                            <div class="form-group-separator"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="action_name" value="<?php echo ($menu["action_name"]); ?>" name="action_name" placeholder="方法名称">
                                </div>
                            </div>
                            <div class="form-group-separator"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="data" name="data" value="<?php echo ($menu["data"]); ?>" placeholder="参数值">
                                </div>
                            </div>
                            <div class="form-group-separator"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="data" name="ico" value="<?php echo ($menu["ico"]); ?>" placeholder="ico参数值">
                                </div>
                            </div>
                            <div class="form-group-separator"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="remark" value="<?php echo ($menu["remark"]); ?>" name="remark" placeholder="请输入备注信息！">
                                </div>
                            </div>
                            <div class="form-group-separator"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" id="ordid" value="<?php echo ($menu["ordid"]); ?>" value="255" name="ordid">
                                </div>
                            </div>
                            <div class="form-group-separator"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="radio">
                                        <label>
                                            ...
                                            <?php if($menu["display"] == 1): ?>checked="checked"<?php endif; ?>
                                            id="display" value="1" />
                                            显示 </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="display"
                                            <?php if($menu["display"] == 0): ?>checked="checked"<?php endif; ?>
                                            value="0" >
                                            不显示 </label>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-10">
                                    <div class="radio">
                                        <label>
                                            ...
                                            <?php if($menu["log"] == 1): ?>checked="checked"<?php endif; ?>
                                            id="log" value="1" />
                                            记录日志
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="log"
                                            <?php if($menu["log"] == 0): ?>checked="checked"<?php endif; ?>
                                            value="0" >
                                            不记录日志
                                        </label>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="submit" class="btn btn-secondary  btn-single" value="修改">
                                </div>
                            </div>
                        </form>
                    </div>
