                    ...
                    <div class="row col-margin">
                        <div class="row">
                            <form method="get" role="form" class="form-inline">
                                <div class="col-sm-2">
                                    <input type="text" name="username" value="<?php echo I('get.username');?>" class="form-control" placeholder="请输入账号或姓名" />
                                </div>
                                <div class="col-sm-2">
                                    <select name="department_id" class="form-control">
                                        <option value="0">选择部门</option>
                                        <?php if(is_array($department_list)): foreach($department_list as $k=>$v): ?><option value="<?php echo ($k); ?>"
                                            <?php if(I('get.department_id') == $k): ?>selected<?php endif; ?>
                                ...
                                <div class="col-sm-2">
                                    <select name="role_id" class="form-control">
                                        ...
                                        <?php if(is_array($role_list)): foreach($role_list as $k=>$v): ?><option value="<?php echo ($k); ?>"
                                            <?php if(I('get.role_id') == $k): ?>selected<?php endif; ?>
                                            ><?php echo ($v); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>
                                <div class="col-sm-2">
                        ...
                        <div class="table-responsive" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk" data-sticky-table-header="true" data-add-display-all-btn="true" data-add-focus-btn="true">
                            <table cellspacing="0" class="table table-small-font table-bordered table-striped">
                                ...
                                <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                                        ...
                                        <td><?php echo ($vo["department_name"]); ?> - <?php echo ($vo["position_level"]); ?></td>
                                        <td><?php echo ($vo["last_ip"]); ?></td>
                                        <td><?php echo (date("Y-m-d H:i",$vo["last_time"])); ?></td>
                                        <td><?php echo ($vo["email"]); ?></td>
                                        <td>
                                            <?php if($vo["status"] != 1 ): ?>不启用
                                                <?php else: ?>
                                                启用<?php endif; ?>
                                        </td>
                                        <td>
                                            <a href="/AppAdmin/Setting/adminEdit/id/<?php echo ($vo["id"]); ?>" class="ibutton"><i class="fa-edit"></i></a>
                                            |
                                            <a href="javascript:void(0);" class="J_confirmurl" onclick="deleteUser(<?php echo ($vo['id']); ?>)">
                                                <i class="fa-trash"></i>
                                            </a>
                                        </td>
...
<script type="text/javascript">
    ...
    <script type="text/javascript">
        function deleteUser(id) {
            $res = confirm('确定删除此账号？');
            if ($res) {
                var url = "<?php echo U('Setting/adminDel');?>";
