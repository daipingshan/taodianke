        ...
        <div class="page-title">
            ...
            <div class="breadcrumb-env">
                <ol class="breadcrumb bc-1">
                    <li> <a href="<?php echo U('Index/index');?>"><i class="fa-home"></i>主页</a> </li>
            ...
            <div class="panel panel-default col-sm-12">
                ...
                <div class="panel-body">
                    <div class="row col-margin">
                        <form method="get" action="<?php echo U('Wechat/getCustomerInfo');?>">
                            <div class="row col-margin">
                                <div class="col-xs-2">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk" data-sticky-table-header="true" data-add-display-all-btn="true" data-add-focus-btn="true">
                            <table cellspacing="0" class="table table-small-font table-bordered table-striped">
                                ...
                                <tbody>
                                <?php if(is_array($customer)): $i = 0; $__LIST__ = $customer;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        <th><?php echo ($vo["id"]); ?></th>
                                        <td><?php echo ($vo["nickname"]); ?></td>
                                        <td><img src="<?php echo ($vo["headimgurl"]); ?>" width="70px" height="70px"/></td>
                                        <td><?php echo ($vo["country"]); ?>-<?php echo ($vo["province"]); ?>-<?php echo ($vo["city"]); ?></td>
                                        <td><?php echo (date('Y-m-d H:i', $vo["add_time"])); ?></td>
                                        <td><?php echo ($user[$vo['proxy_pid']]['real_name']); ?></td>
...
<script type="text/javascript">
    $("#department_id").change(function(){
        var id = $(this).val();
        var get_url = "<?php echo U('Merchant/getDepartmenPersonnel');?>";
...
<script type="text/javascript">
    function del(id){
        $res = confirm('确定删除该商家');
        if ($res) {
            var post_url = "<?php echo U('Merchant/del');?>";
            var index = "<?php echo U('Merchant/index');?>";
