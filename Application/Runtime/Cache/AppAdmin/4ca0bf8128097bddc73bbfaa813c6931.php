                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-block">
                                            <textarea class="form-control check" id="first_subscribe"
                                                      placeholder="请输入首次关注提示信息！" name="WEIXIN_MP[first_subscribe_msg]"
                                                      rows="10"><?php echo ($content['WEIXIN_MP']['first_subscribe_msg']); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-block">
                                            <textarea class="form-control check" id="repeat_msg"
                                                      ...
                                                      name="WEIXIN_MP[repeat_subscribe_msg]" rows="10"><?php echo ($content['WEIXIN_MP']['repeat_subscribe_msg']); ?></textarea>
                                        </div>
                                    </div>
                                    <div style="clear: both"></div>
                                </div>
                                        ...
                                        <div class="form-block">
                                            <label>
                                                <input type="text" class="form-control check" id="weixin_title"
                                                       name="WEIXIN_MP[title]" value="<?php echo ($content['WEIXIN_MP']['title']); ?>"
                                        ...
                                        <div class="form-block">
                                            <label>
                                                <input type="text" class="form-control check" id="bg_image"
                                                       name="WEIXIN_MP[bg_image]"
                                                       value="<?php echo ($content['WEIXIN_MP']['bg_image']); ?>"
                                        ...
                                        <div class="form-block">
                                            <label>
                                                <input type="text" class="form-control check" id="bg_url"
                                                       name="WEIXIN_MP[bg_url]"
                                                       value="<?php echo ($content['WEIXIN_MP']['bg_url']); ?>"
                    ...
                    <div class="tab-pane" id="home-2">
                        <form class="save">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control check" id="app_id" name="WEIXIN_BASE[app_id]"
                                           value="<?php echo ($content['WEIXIN_BASE']['app_id']); ?>" placeholder="请输入微信开发app_id！">
                                </div>
                                <div style="clear: both"></div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control check" id="app_secret"
                                           name="WEIXIN_BASE[app_secret]"
                                           value="<?php echo ($content['WEIXIN_BASE']['app_secret']); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control check"
                                           name="WEIXIN_BASE[public_number_url]"
                                           value="<?php echo ($content['WEIXIN_BASE']['public_number_url']); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control check" id="check_coupon_tmpl_id"
                                           name="WEIXIN_BASE[check_coupon_tmpl_id]"
                                           value="<?php echo ($content['WEIXIN_BASE']['check_coupon_tmpl_id']); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control check" id="deal_end_tmpl_id"
                                           name="WEIXIN_BASE[deal_end_tmpl_id]"
                                           value="<?php echo ($content['WEIXIN_BASE']['deal_end_tmpl_id']); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control check" placeholder="请输入正确的菜单内容！"
                                              name="WEIXIN_BASE[footer_menu]"
                                              rows="15"><?php echo ($content['WEIXIN_BASE']['footer_menu']); ?></textarea>
                                </div>
                                <div style="clear: both"></div>
                            </div>
                            <div class="form-group">
