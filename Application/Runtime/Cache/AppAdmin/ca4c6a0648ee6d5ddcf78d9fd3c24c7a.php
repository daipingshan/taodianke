	...
	<ul class="user-info-menu right-links list-inline list-unstyled">
        ...
        <div class="page-title">
            <div class="title-env">
                ...
                <p class="description">设定后台角色管理信息。</p>
            </div>
            ...
            <div class="panel panel-default col-sm-12">
                ...
                <div class="panel-body">
                    <div class="row col-margin">
                        <div class="col-xs-2">
                            <a href="/AppAdmin/Setting/positionAdd" class="btn btn-secondary btn-single">添加角色</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="table-responsive" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk" data-sticky-table-header="true" data-add-display-all-btn="true" data-add-focus-btn="true">
                            <table cellspacing="0" class="table table-small-font table-bordered table-striped">
                                ...
                                <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                                        ...
                                        <td>
                                            <a href="/AppAdmin/Setting/positionEdit/id/<?php echo ($vo["id"]); ?>" class="ibutton"><i class="fa-edit"></i></a>
                                            |
                                            <a href="/AppAdmin/Setting/positionDel/id/<?php echo ($vo["id"]); ?>" onclick="confirm('确定删除么？');" class="ibutton"><i class="fa-trash"></i></a>
                                        </td>
