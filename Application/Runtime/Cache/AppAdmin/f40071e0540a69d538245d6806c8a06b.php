            ...
            <div class="panel panel-default col-sm-12">
                ...
                <div class="panel-body">
                    <div class="row col-margin">
                        <div class="col-xs-2">
                            <a href="<?php echo U('Department/add');?>" class="btn btn-secondary btn-single">
                                添加部门
                            </a>
                        </div>
                    </div>
                            ...
                            <table cellspacing="0" class="table table-small-font table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td><?php echo ($vo["superior_department_name"]); ?></td>

                                            <td>
                                                <a href="<?php echo U('Department/edit',array('id'=>$vo['id']));?>" class="ibutton">
                                                <i class="fa-edit"></i>
                                                </a>
...
<script type="text/javascript">
    function delet(id){
        $res = confirm('确定删除该商家');
        if ($res) {
            var post_url = "<?php echo U('Department/del');?>";
            var index = "<?php echo U('Department/index');?>";
