	...
	<ul class="user-info-menu right-links list-inline list-unstyled">
        ...
        <div class="page-title">
            <div class="title-env">
                ...
                <p class="description">公司概况</p>
            </div>
            <div class="breadcrumb-env">
                <ol class="breadcrumb bc-1">
                    <li><a href="/AppAdmin/"><i class="fa-home"></i>主页</a></li>
                    <li class="active"> BI统计</li>
                    <li class="active"><strong>公司概况</strong></li>
                </ol>
            </div>
        </div>
        <div class="panel panel-default col-sm-12">
            <div class="panel-heading">
                <h3 class="panel-title">淘客付款预估收入/结算预估收入</h3>
            </div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-3">
                        <div class="xe-widget xe-counter-block xe-counter-block-blue" data-suffix="k" data-count=".num"
                            ...
                            <div class="xe-upper">
                                ...
                                <div class="xe-label">
                                    <strong class="num">¥<?php echo ($today_paid); ?></strong>
                                    <span>今日付款总预估收入</span>
                                </div>
                            </div>
                            <div class="xe-lower">
                    ...
                    <div class="col-sm-3">
                        <div class="xe-widget xe-counter-block xe-counter-block-red" data-suffix="k" data-count=".num"
                             data-from="0" data-to="310" data-duration="4" data-easing="false">
                            <div class="xe-upper">
                                <div class="xe-icon">
                                    <i class="fa-life-ring"></i>
                                ...
                                <div class="xe-label">
                                    <strong class="num">¥<?php echo ($today_settle); ?></strong>
                                    <span>今日结算总预估收入</span>
                                </div>
                            </div>
                            <div class="xe-lower">
                    ...
                    <div class="col-sm-3">
                        <div class="xe-widget xe-counter-block xe-counter-block-blue" data-suffix="k" data-count=".num"
                            ...
                            <div class="xe-upper">
                                ...
                                <div class="xe-label">
                                    <strong class="num">¥<?php echo ($yes_paid); ?></strong>
                                    <span>昨日付款总预估收入</span>
                                </div>
                            </div>
                            <div class="xe-lower">
                    ...
                    <div class="col-sm-3">
                        <div class="xe-widget xe-counter-block xe-counter-block-red" data-suffix="k" data-count=".num"
                            ...
                            <div class="xe-upper">
                                ...
                                <div class="xe-label">
                                    <strong class="num">¥<?php echo ($yes_settle); ?></strong>
                                    <span>昨日结算总预估收入</span>
                                </div>
                            </div>
                            <div class="xe-lower">
        ...
        <div class="panel panel-default col-sm-12">
            <div class="panel-heading">
                <h3 class="panel-title">在线商品数</h3>
            </div>
            <div class="panel-body">
                <div class="row">
                    <?php $item_cate = array('B'=>'淘宝','C'=>'天猫',J=>'楚楚街'); ?>
                    <?php if(is_array($item_list)): $i = 0; $__LIST__ = $item_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><div class="col-sm-4">
                            <div class="xe-widget xe-counter-block xe-counter-block-orange" data-suffix="k"
                                ...
                                <div class="xe-upper">
                                    ...
                                    <div class="xe-label">
                                        <strong class="num"><?php echo ($row["num"]); ?></strong>
                                        <span><?php echo ($item_cate[$row['shop_type']]); ?>在线商品数</span>
                                    </div>
                                </div>
                                <div class="xe-lower">
                                    <div class="border"></div>
