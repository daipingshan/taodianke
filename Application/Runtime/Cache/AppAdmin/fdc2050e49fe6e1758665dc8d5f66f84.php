	...
	<ul class="user-info-menu right-links list-inline list-unstyled">
        ...
        <div class="page-title">
            <div class="title-env">
                ...
                <p class="description">显示所有商品分类</p>
            </div>
            <div class="breadcrumb-env">
                <ol class="breadcrumb bc-1">
                    <li><a href="/AppAdmin/"><i class="fa-home"></i>主页</a></li>
                    <li class="active"> 商品管理</li>
                    <li class="active"><strong>商品分类</strong></li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="col-xs-2">
                            <a href="<?php echo U('Items/addCate');?>" class="btn btn-secondary btn-single">
                                添加分类
                            </a>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table cellspacing="0" class="table table-small-font table-bordered table-striped">
                                ...
                                <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                                        ...
                                        <td>
                                            <img src="<?php echo getImgUrl($vo['cateimg']);?>" width="80">
                                        </td>
                                        ...
                                        <td>
                                            <a href="<?php echo U('Items/updateCate',array('id'=>$vo['id']));?>">
                                                <button class="btn btn-secondary"><font><font>修改</font></font></button>
                                            </a>

                                            <button class="btn" data-clipboard-text="taodianke://Item/index?condition=1&cate_id=<?php echo ($vo['id']); ?>&page=1&V=2&app_title=<?php echo ($vo['name']); ?>">复制URL</button>
