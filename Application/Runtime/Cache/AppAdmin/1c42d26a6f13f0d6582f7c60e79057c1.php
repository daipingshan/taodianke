      ...
      <form method="get">
        <div class="panel-body">
          <div class="row col-margin">
            <div class="col-xs-2">
              <input type="text" name="id"  class="form-control" value="<?php echo I('get.id');?>" placeholder="订单号"/>
            </div>
            <div class="col-xs-2">
              <input type="text" name="title"  class="form-control" value="<?php echo I('get.title');?>" placeholder="商品名称"/>
            </div>
            <div class="col-xs-2">
              <input type="text" name="item_id"  class="form-control" value="<?php echo I('get.item_id');?>" placeholder="商品ID"/>
            </div>
            <div class="col-xs-1">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">订单(<?php echo ($count); ?>) 订单总额：￥<?php echo ($amount); ?>元</h3>
            ...
            <table cellspacing="0" class="table table-small-font table-bordered table-striped">
              ...
              <tbody>
                <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                    ...
                    <th><a href="https://item.taobao.com/item.htm?id=<?php echo ($vo["itemid"]); ?>" target="_blank"><?php echo ($vo["title"]); ?></a></th>
                    <td><?php echo ($vo["number"]); ?></td>
                    <td><?php echo ($vo["discount_rate"]); ?></td>
                    <td><?php echo ($vo["fee"]); ?></td>
                    <td><?php echo ($vo["create_time"]); ?></td>
                    <td><?php echo ($vo["earningtime"]); ?></td>
                    <td><?php echo ($vo["paystatus"]); ?></td>
