...
<head>
    ...
    <title>您要找的'<?php echo ($keyword); ?>'相关商品--淘店客您身边的购物神器  </title>
...
<div id="containter" class="container">
    ...
    <div class="tiger_nav1" id="head_seach">
        <div class="seach_nav">
            ...
            <div class="seach_2">
                <span class="t-index">您搜的'<?php echo ($keyword); ?>'相关商品</span>
            </div>
        ...
        <div class="seach_nav">
            ...
            <div class="seach_2">
                <form id="search-form" action="<?php echo U('Item/search');?>" method="get">
                    ...
                    <input type="text" id="keyword" name="keyword" value="<?php echo ($keyword); ?>" class="tige_sear" placeholder="请输入您要找的商品"/>
    ...
    <div class="goods_list index_goodslist">
        <section class="goods" id="pageCon">
            <ul id="list_box" class="list_box">
                <link rel="stylesheet" href="https://pic.taodianke.com//static/Touch/css/dropload.css?v=<?php echo ($version); ?>">
<script src="https://pic.taodianke.com//static/Touch/js/dropload.min.js?v=<?php echo ($version); ?>"></script>
    ...
    $(function () {
        ...
        $(window).scroll(function () {
            ...
            if (btop < $(window).height() + $(document).scrollTop()) {
                ...
                $.getJSON(ajaxurl, {p: p, uid: uid, keyword:keyword}, function (renul) {
                    console.log(ajaxurl);
                    ...
                    (function (sqlJson) {
                        if (p > maxpage) {
                            ...
                            for (var i in sqlJson) {
                                ...
                                var aa = $(".list_box li").innerWidth();
                                $(".list_box li img").css('height', aa);
                            }
...
<?php if(is_array($item)): $i = 0; $__LIST__ = $item;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><li class="relative">
            ...
            <a href="<?php echo ($item['item_url']); ?>">
                <div class="goodspc">
                    <div class="goods_price">
                        <span style="font-size:12px;">券后价:</span><span>￥<?php echo ($item['coupon_price']); ?></span>
                    </div>
