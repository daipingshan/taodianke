...
<head>
    ...
    <title>淘店客</title>
    <link href="http://pic.taodianke.com//static/Touch/css/style.css" rel="stylesheet" />
    <link href="http://pic.taodianke.com//static/Touch/css/swipper.css" rel="stylesheet" />
    <link href="http://pic.taodianke.com//static/Touch/css/preload.css" rel="stylesheet" />
    <link href="http://pic.taodianke.com//static/Touch/css/loading.css" rel="stylesheet" />
    <link href="http://pic.taodianke.com//static/Touch/css/nav.css" rel="stylesheet"/>
    <script src="https://cdn.bootcss.com/jquery/2.2.4/jquery.min.js"></script>
    <script src="http://pic.taodianke.com//static/Touch/js/nav.js"></script>
    <script>
...
<style>
    ...
    #mask #day-sign-ok {
        ...
        width: 90%;
        height: 70%;
        background-image: url(http://pic.taodianke.com//static/Touch/images/day-sign-ok-imgs.png);
        background-repeat: no-repeat;
        background-size: 100% 100%;
    }
    ...
    #mask #close {
        ...
        height: 50px;
        margin: 0 44%;
        background-image: url(http://pic.taodianke.com//static/Touch/images/close.png);
        background-repeat: no-repeat;
        background-size: 100% 100%;
    }
            ...
            <div class="seach_2" style="width:68%;">
                <form id="search-form" action="<?php echo U('Item/search');?>" method="get">
                    ...
                    <button id="tiger_search-submit" type="submit" onclick="searchan()">
                        <img src="http://pic.taodianke.com//static/Touch/images/search.png"/>
                    </button>
                </form>
            </div>
            <!-- <div id="day-sign"
             <?php if(($is_day_sign) == "1"): ?>style="background-image: url(http://pic.taodianke.com//static/Touch/images/day-sign-ok.png);"
                 <?php else: ?>
                 onclick="day_sign()" style="background-image: url(http://pic.taodianke.com//static/Touch/images/day-sign.png);"<?php endif; ?>
             >-->
            <div class="seach_3" data-url="<?php echo U('Index/index',array('uid'=>$uid));?>"
...
<div class="goods_list index_goodslist">
    ...
    <section class="goods" id="pageCon">
        <ul id="list_box" class="list_box">
            <link rel="stylesheet" href="http://pic.taodianke.com//static/Touch/css/dropload.css">
<script src="http://pic.taodianke.com//static/Touch/js/dropload.min.js"></script>
                        ...
                        if(p>maxpage){
                            ...
                            for(var i in sqlJson){
                                ...
                                if (sqlJson[i]['shop_type'] == 'C') {
                                    ...
                                    content += '<div class="comefrom" style="background: url(http://pic.taodianke.com//static/Touch/images/chuchu.png) no-repeat left center/15px;">楚楚街</div>';
                                }else {
                                    content += '<div class="comefrom" style="background: url(http://pic.taodianke.com//static/Touch/images/taobao.png) no-repeat left center/15px;">淘宝</div>';
                                }
        ...
        <div class="goods_bottom">
            ...
            <a href="<?php echo ($item['item_url']); ?>">
                <?php if($item['shop_type'] == 'C'): ?><div class="comefrom">天猫</div>
                    ...
                    <div class="comefrom" style="background: url(http://pic.taodianke.com//static/Touch/images/chuchu.png) no-repeat left center/15px;">楚楚街</div>
                    <?php else: ?>
                    <div class="comefrom" style="background: url(http://pic.taodianke.com//static/Touch/images/taobao.png) no-repeat left center/15px;">淘宝</div><?php endif; ?>
...
<script src="http://pic.taodianke.com//static/Touch/js/idangerous.swiper.min.js"></script>
<script src="http://pic.taodianke.com//static/Touch/js/common_phone.js"></script>
<script src="http://pic.taodianke.com//static/Touch/js/layer.js"></script>
<script>
    ...
    function day_sign() {
        if (isWeiXin()) {
            $.get("<?php echo U('daySign');?>", {}, function (res) {
                if (res.status == 1) {
                    $('#mask').show();
                    $('#day-sign').attr('onclick', 'javascript:;').css('background-image', 'url(http://pic.taodianke.com//static/Touch/images/day-sign-ok.png)');
