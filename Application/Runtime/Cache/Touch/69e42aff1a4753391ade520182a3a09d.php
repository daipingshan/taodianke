...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://pic.taodianke.com//static/Touch/css/style_v3.css"/>
    <link href="http://pic.taodianke.com//static/Touch/css/main.css?version=<?php echo C('version');?>" rel="stylesheet">
    <link href="http://pic.taodianke.com//static/Touch/css/detail.css?version=<?php echo C('version');?>" rel="stylesheet">
    <link rel="stylesheet" href="http://pic.taodianke.com//static/Touch/css/layer.css?version=<?php echo C('version');?>" id="layui_layer_skinlayercss">
</head>
<body>
...
<div id="pull" class=" detail-product">
    <div class="scroll-box">
                ...
                <div class="media-list-info flex-center oh">
                    <div class="flex-col">
                        ...
                        <span class="fl coupon-price">
                            ...
                            <img src="http://pic.taodianke.com//static/Touch/images/quan_03.png" alt="">
                        </span>
                    </div>
                    <div class="sales">
                        <img src="http://pic.taodianke.com//static/Touch/images/head_06.png" alt="">
        ...
        <div class="detail-load-failed">
            <a href="javascript:;">
                <span> <b class="fl">查看图文详情</b> <img src="http://pic.taodianke.com//static/Touch/images/arrow_03.png" alt=""></span>
            </a>
        </div><?php endif; ?>
        <!--内容-->
...
<div class="dialog">
    ...
    <div class="detail-mask-content">
        <div class="detail-mask-allow">
            <img src="http://pic.taodianke.com//static/Touch/images/allow-top.png" alt="">
        </div>
        <div class="detail-mask-command">
            <div class="detail-mask-command-head">
                <div class="detail-mask-command-ios">
                    <p><span>请点击右上角</span> <img src="http://pic.taodianke.com//static/Touch/images/browser-allow.png" alt=""></p>
                    <p><span>并选择<i>在<i class="media-arial">Safari</i>中打开</i></span> <img src="http://pic.taodianke.com//static/Touch/images/browser.png" alt=""></p>
                </div>
                <div class="detail-mask-command-android">
                    <p><span>请点击右上角</span> <img class="android-img" src="http://pic.taodianke.com//static/Touch/images/browser-allow.png" alt=""></p>
...
<script src="http://pic.taodianke.com//static/Touch/js/jquery.2.1.4.js"></script>
<script src="http://pic.taodianke.com//static/Touch/js/layer.js?version=<?php echo C('version');?>"></script>
<script src="http://pic.taodianke.com//static/Touch/js/imgLazy.v1.js?version=<?php echo C('version');?>"></script>
<script src="http://pic.taodianke.com//static/Touch/js/clip-board.min.js"></script>
<script src="http://pic.taodianke.com//static/Touch/js/detail.js?version=<?php echo C('version');?>"></script>
