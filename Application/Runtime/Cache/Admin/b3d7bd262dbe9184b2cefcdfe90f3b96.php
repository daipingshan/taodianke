...
function show_message_tip($obj){
    ...
    <div class="row">
        <div class="col-lg-6">
            <form action="<?php echo U('Order/GetNews');?>" method='post'>
            <div class="form-group input-group">
                <input type="text" class="form-control" name='query' value='<?php echo ($query); ?>' placeholder="要查看的网址">
                    ...
                    <div class="table-responsive">
                       <ul>
                            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                                <p><img height="200" width="200" src="<?php echo ($vo["img"]); ?>"></p>
                                <div>
                                    <p><a target="_blank" href="<?php echo ($vo["real_url"]); ?>"><?php echo ($vo["name"]); ?>-价格：<?php echo ($vo["price"]); ?></a></p>
                                </div>
                            </li><?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                    </div>
