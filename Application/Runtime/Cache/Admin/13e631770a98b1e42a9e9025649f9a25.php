                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><td><?php echo ($vo["name"]); ?></td>
                                <td><?php echo ($vo["news_num"]); ?></td>
                                <td><?php echo ($vo["order_num"]); ?></td>
                                <td><?php echo ($vo["order_fee"]); ?></td>
                                <td>
                                    <a class="btn btn-primary add-cart"
                                       href="<?php echo U('articleOrder',array('user_id'=>$vo['user_id'],'time'=>$time));?>">查看详情</a>
                                </td>
        ...
        series: [
            {
                ...
                data: <?php echo ($news_num); ?>
            },
            {
                name: '订单数量',
                type: 'line',
                itemStyle: {normal: {areaStyle: {type: 'default'}}},
                data: <?php echo ($order_num); ?>
            },
            {
                name: '总佣金',
                type: 'line',
