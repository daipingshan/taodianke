...
function show_message_tip($obj){
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <form>
                ...
                <div class="col-lg-2">
                    <input type="number" class="form-control" name='read_num' value="<?php echo ($url_param['read_num']); ?>"
                           placeholder="阅读量大于">
                </div>
                <div class="col-lg-2">
                    <select name="source" class="form-control">
                        ...
                        >淘宝</option>
                        <option value="3"
                        <?php if($url_param['source'] == 3): ?>selected<?php endif; ?>
                        >放心购</option>
                    </select>
                </div>
                <div class="col-lg-3">
                ...
                <div class="col-lg-2">
                    <select name="sort" class="form-control">
                        ...
                        <option value="2"
                        <?php if($url_param['sort'] == 2): ?>selected<?php endif; ?>
                        >阅读量从高到低</option>
                    </select>
                </div>
                <div>
                ...
                <?php if(is_array($row)): $i = 0; $__LIST__ = $row;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-lg-3 box">
                        ...
                        <div class="content">
                            ...
                            <div class="col-lg-12 no-padding">
                                ...
                                <div class="col-lg-6 no-padding">阅读量：<span style="color:#FF420F;font-weight: 700 "><?php echo ($vo['go_detail_count']); ?></span>
                                </div>
                            </div>
    ...
    <div class="row" style="margin: 20px 0 50px 0">
        ...
        <div class="col-lg-4">
            <?php $url_param['uid'] = I('get.uid'); ?>
            <?php if($page > 1): $url_param['page'] = 1 ?>
                <a href="<?php echo U('itemsMoreList');?>?<?php echo http_build_query($url_param);?>">
                    <button class="btn btn-danger">第一页</button>
                </a>
                <?php $url_param['page'] = $page-1 ?>
                <a href="<?php echo U('itemsMoreList');?>?<?php echo http_build_query($url_param);?>">
                    <button class="btn btn-danger">上一页</button>
                </a><?php endif; ?>
            <button class="btn btn-danger"><?php echo ($page); ?></button>
            <?php if($is_last == true): $url_param['page'] = $page+1 ?>
                <a href="<?php echo U('itemsMoreList');?>?<?php echo http_build_query($url_param);?>">
