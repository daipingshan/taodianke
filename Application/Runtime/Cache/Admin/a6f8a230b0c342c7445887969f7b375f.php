...
function show_message_tip($obj){
    ...
    <div class="row">
        <div class="col-lg-6">
            <form action="<?php echo U('News/searsch');?>" method='get'>
                <div style="float: left; margin-right: 20px;">
                    <select class="form-control" name='newstype' >
                        <option value=''>请选择</option>
                        <option value="1" <?php if((${newid}) == "1"): ?>selected<?php endif; ?> >女装</option>
                        <option value="3" <?php if((${newid}) == "3"): ?>selected<?php endif; ?> >男装</option>
                        <option value="2" <?php if((${newid}) == "2"): ?>selected<?php endif; ?> >会生活</option>
                    </select>
                </div>
                <div style="float: left; margin-right: 20px;">
                    <input type="text" readonly style="width: 200px" name="time" id="reservation" class="form-control" value="<?php echo ($time); ?>" />
                </div>
                    ...
                    <div class="table-responsive">
                       <ul>
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                                <p><img height="200" width="200" src="<?php echo ($vo["image"]); ?>"></p>
                                <div>
                                    <p><a target="_blank" href="<?php echo ($vo["url"]); ?>"><?php echo ($vo["title"]); ?>-<?php echo ($vo["news_id"]); ?>-<?php echo (date("Y-m-d H:i:s",$vo["behot_time"])); ?></a></p>
                                    <?php if($uid == '0'): ?><p><?php echo ($vo["content"]); ?></p>
                                        <?php else: endif; ?>
                                </div>
                            </li><?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
