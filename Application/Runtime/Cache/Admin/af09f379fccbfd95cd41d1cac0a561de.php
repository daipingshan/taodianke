...
function show_message_tip($obj){
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">放心购订单管理</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
    <div class="row">
        <div class="col-lg-12 form-group">
            <div class="row">
                ...
                <p>状元：<?php echo ($cout[0]['name']); ?> 成绩：<?php echo ($cout[0]['cout']); ?>
                榜眼：<?php echo ($cout[1]['name']); ?> 成绩：<?php echo ($cout[1]['cout']); ?>
                探花：<?php echo ($cout[2]['name']); ?> 成绩：<?php echo ($cout[2]['cout']); ?></p>
                <div>未上榜的同学继续努力，相信下次就是你</div>
                <p><a href="GetYsdOrder1.html" target="_blank" style="color:red; ">查看昨天订单情况</a></p>
                <h4><?php echo ($nwtime); ?>实时前三甲 刷新哦说不定你就上榜了</h4>
                <p>状元：<?php echo ($tadaycou[0]['name']); ?> 成绩：<?php echo ($tadaycou[0]['cout']); ?>
                榜眼：<?php echo ($tadaycou[1]['name']); ?> 成绩：<?php echo ($tadaycou[1]['cout']); ?>
                探花：<?php echo ($tadaycou[2]['name']); ?> 成绩：<?php echo ($tadaycou[2]['cout']); ?></p>
            </div>
            <p style="">
                ...
                <span style="display: block;"><a href="GetmyOrder1.html">查看我的订单</a></span>
            </p>
        </div>
        <?php if($uid == '0'): ?><div id="pp" style="position:absolute; right: 10px; top: 52px; ">
              ...
              <div style="float: left; margin-right:10px;  height: 310px;overflow-y:auto;width: 230px; ">
                  <?php if(is_array($tadaycou)): $i = 0; $__LIST__ = $tadaycou;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dd): $mod = ($i % 2 );++$i;?><p><?php echo ($dd["name"]); ?>--成绩--<?php echo ($dd["cout"]); ?></p><?php endforeach; endif; else: echo "" ;endif; ?>
              </div>
              <div style="float: right;margin-right: 10px; height: 310px;overflow-y:auto;width: 220px;">
                  <?php if(is_array($monthcout)): $i = 0; $__LIST__ = $monthcout;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ddd): $mod = ($i % 2 );++$i;?><p><?php echo ($ddd["name"]); ?>--成绩--<?php echo ($ddd["cout"]); ?></p><?php endforeach; endif; else: echo "" ;endif; ?>
              </div>
           <div style="clear: both;"></div>
            ...
            <div id="ppp" style="position:absolute; right: 10px; top: 52px; ">
                <div style="float: left; margin-right:5px;  height: 310px;overflow-y:auto;width: 180px; ">
                    <p>本月排名</p>
                    <p><?php echo ($monthcout[0]['name']); ?>--成绩--<?php echo ($monthcout[0]['cout']); ?></p>
                    <p><?php echo ($monthcout[1]['name']); ?>--成绩--<?php echo ($monthcout[1]['cout']); ?></p>
                    <p><?php echo ($monthcout[2]['name']); ?>--成绩--<?php echo ($monthcout[2]['cout']); ?></p>
                    <p><?php echo ($monthcout[3]['name']); ?>--成绩--<?php echo ($monthcout[3]['cout']); ?></p>
                    <p><?php echo ($monthcout[4]['name']); ?>--成绩--<?php echo ($monthcout[4]['cout']); ?></p>
                    <p><?php echo ($monthcout[5]['name']); ?>--成绩--<?php echo ($monthcout[5]['cout']); ?></p>
                    <p><?php echo ($monthcout[6]['name']); ?>--成绩--<?php echo ($monthcout[6]['cout']); ?></p>
                    <p><?php echo ($monthcout[7]['name']); ?>--成绩--<?php echo ($monthcout[7]['cout']); ?></p>
                    <p><?php echo ($monthcout[8]['name']); ?>--成绩--<?php echo ($monthcout[8]['cout']); ?></p>
                    <p><?php echo ($monthcout[9]['name']); ?>--成绩--<?php echo ($monthcout[9]['cout']); ?></p>
                    <p><?php echo ($monthcout[10]['name']); ?>--成绩--<?php echo ($monthcout[10]['cout']); ?></p>
                    <p><?php echo ($monthcout[11]['name']); ?>--成绩--<?php echo ($monthcout[11]['cout']); ?></p>

                </div>
                <div style="float: left; margin-right:5px;  height: 310px;overflow-y:auto;width: 180px; ">
                    <p><?php echo ($sdate); ?>排名</p>
                    <p><?php echo ($cout[0]['name']); ?>--成绩--<?php echo ($cout[0]['cout']); ?></p>
                    <p><?php echo ($cout[1]['name']); ?>--成绩--<?php echo ($cout[1]['cout']); ?></p>
                    <p><?php echo ($cout[2]['name']); ?>--成绩--<?php echo ($cout[2]['cout']); ?></p>
                    <p><?php echo ($cout[3]['name']); ?>--成绩--<?php echo ($cout[3]['cout']); ?></p>
                    <p><?php echo ($cout[4]['name']); ?>--成绩--<?php echo ($cout[4]['cout']); ?></p>
                    <p><?php echo ($cout[5]['name']); ?>--成绩--<?php echo ($cout[5]['cout']); ?></p>
                    <p><?php echo ($cout[6]['name']); ?>--成绩--<?php echo ($cout[6]['cout']); ?></p>
                    <p><?php echo ($cout[7]['name']); ?>--成绩--<?php echo ($cout[7]['cout']); ?></p>
                    <p><?php echo ($cout[8]['name']); ?>--成绩--<?php echo ($cout[8]['cout']); ?></p>
                    <p><?php echo ($cout[9]['name']); ?>--成绩--<?php echo ($cout[9]['cout']); ?></p>
                    <p><?php echo ($cout[10]['name']); ?>--成绩--<?php echo ($cout[10]['cout']); ?></p>
                    <p><?php echo ($cout[11]['name']); ?>--成绩--<?php echo ($cout[11]['cout']); ?></p>
                </div>
                <div style="float: right;margin-right: 5px; height: 310px;overflow-y:auto;width: 180px;">
                    <p><?php echo ($nwtime); ?>排名</p>
                    <p><?php echo ($tadaycou[0]['name']); ?>--成绩--<?php echo ($tadaycou[0]['cout']); ?></p>
                    <p><?php echo ($tadaycou[1]['name']); ?>--成绩--<?php echo ($tadaycou[1]['cout']); ?></p>
                    <p><?php echo ($tadaycou[2]['name']); ?>--成绩--<?php echo ($tadaycou[2]['cout']); ?></p>
                    <p><?php echo ($tadaycou[3]['name']); ?>--成绩--<?php echo ($tadaycou[3]['cout']); ?></p>
                    <p><?php echo ($tadaycou[4]['name']); ?>--成绩--<?php echo ($tadaycou[4]['cout']); ?></p>
                    <p><?php echo ($tadaycou[5]['name']); ?>--成绩--<?php echo ($tadaycou[5]['cout']); ?></p>
                    <p><?php echo ($tadaycou[6]['name']); ?>--成绩--<?php echo ($tadaycou[6]['cout']); ?></p>
                    <p><?php echo ($tadaycou[7]['name']); ?>--成绩--<?php echo ($tadaycou[7]['cout']); ?></p>
                    <p><?php echo ($tadaycou[8]['name']); ?>--成绩--<?php echo ($tadaycou[8]['cout']); ?></p>
                    <p><?php echo ($tadaycou[9]['name']); ?>--成绩--<?php echo ($tadaycou[9]['cout']); ?></p>
                    <p><?php echo ($tadaycou[10]['name']); ?>--成绩--<?php echo ($tadaycou[10]['cout']); ?></p>
                    <p><?php echo ($tadaycou[11]['name']); ?>--成绩--<?php echo ($tadaycou[11]['cout']); ?></p>
                </div>
                <div style="clear: both;"></div>
            </div>
            <?php else: ?>
