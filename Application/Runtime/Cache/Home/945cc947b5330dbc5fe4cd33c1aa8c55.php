...
<div class="content" id="body-content">
    ...
    <div class="goods-pages">
        ...
        data-id="0" data-type="sort"><a href="<?php echo U('Item/hot',array('sort'=>0));?>">综合</a></span>
        <span
        <?php if($sort == 1): ?>class="pxclick cur"
            <?php else: ?>
            class="pxclick"<?php endif; ?>
        data-id="1" data-type="sort"><a href="<?php echo U('Item/hot',array('sort'=>1));?>">最新</a></span>
        <span
        <?php if($sort == 3): ?>class="pxclick cur"
            <?php else: ?>
            class="pxclick"<?php endif; ?>
        data-id="3" data-type="sort"><a href="<?php echo U('Item/hot',array('sort'=>3));?>">销量</a></span>
        <span
        <?php if($sort == 2): ?>class="pxclick cur"
            <?php else: ?>
            class="pxclick"<?php endif; ?>
        data-id="2" data-type="sort"><a href="<?php echo U('Item/hot',array('sort'=>2));?>">价格</a></span>
    </div>
